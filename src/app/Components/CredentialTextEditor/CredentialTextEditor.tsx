...
import {CredentialTextEditorProps} from 'app/Modal/Modal'
import ClassicEditor from '@ckeditor/ckeditor5-build-classic'
import {FormikKeys} from '../TextArea'
import './CredentialTextEditor.scss'


const CredentialTextEditor: React.FC<CredentialTextEditorProps> = ({formik, label, name}) => {
...
return (
    ...
    <div
        className='col-lg-10 col-xl-8 col-sm-10 fv-row'
...
export default CredentialTextEditor
